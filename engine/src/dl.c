...
static void        li_dl_close_dlfcn(li_dl_t dl);
...
# ifndef LI_DL_MAX_ERROR_WIN32
#  define LI_DL_MAX_ERROR_WIN32 256
# endif
...
static void        li_dl_close_win32(li_dl_t dl);
...
static char li_dl_error_str_win32[LI_DL_MAX_ERROR_WIN32];
...
static void li_dl_error_win32(void) {
    FormatMessage(
        ...
        li_dl_error_str_win32, LI_DL_MAX_ERROR_WIN32, NULL);
...
static void        li_dl_close_dyld(li_dl_t dl);
