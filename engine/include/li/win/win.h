...
typedef void (*li_win_key_fun_t)(
    li_win_t win, li_win_msg_t msg, li_input_state_t state, li_input_key_t key);
typedef void (*li_win_button_fun_t)(
    li_win_t win, li_win_msg_t msg, li_input_state_t state, int x, int y,
    li_input_button_t button);
typedef void (*li_win_motion_fun_t)(
    li_win_t win, li_win_msg_t msg, li_input_state_t state, int x, int y);
typedef void (*li_win_size_fun_t)(
    li_win_t win, li_win_msg_t msg, int width, int height);
typedef void (*li_win_close_fun_t)(li_win_t win, li_win_msg_t msg);

extern li_win_key_fun_t    li_win_key_fun;
extern li_win_button_fun_t li_win_button_fun;
extern li_win_motion_fun_t li_win_motion_fun;
extern li_win_size_fun_t   li_win_size_fun;
extern li_win_close_fun_t  li_win_close_fun;
