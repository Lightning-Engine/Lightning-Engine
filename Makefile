...
src_engine = $(src_dir_engine)/li_assert.c $(src_dir_engine)/li_gl.c $(src_dir_engine)/li_win.c $(src_dir_engine)/window.cc $(src_dir_engine)/application.cc $(src_dir_engine)/util/log.c $(src_dir_engine)/util/list.c $(src_dir_engine)/memory.c
